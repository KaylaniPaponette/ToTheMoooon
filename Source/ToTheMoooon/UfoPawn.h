...
public:
    ...
    // Add these back - they are now used for rolling the ship
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Components")
    ...
    float MainThrustForce = 15000000.0f; // Renamed for clarity

    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Movement")
    float RollForce = 10000000.0f; // A new force for rolling left/right
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Tractor Beam")
    float TractorBeamRadius = 250.0f;
